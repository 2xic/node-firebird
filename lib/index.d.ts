...
declare module 'node-firebird' {
    type DatabaseCallback = (err: any, db: Database | undefined) => void;
    ...
    export interface ServiceManager {
        ...
        setSweepinterval(db: string, interval: number, callback: ReadableCallback): void; // gfix -h INTERVAL
        setCachebuffer(db: string, nbpages: number, callback: ReadableCallback): void; // gfix -b NBPAGES
